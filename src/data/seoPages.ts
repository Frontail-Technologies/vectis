...
export const seoPagesData: Record<string, SeoLandingPage> = {
  "mtech-projects": {
    slug: "mtech-projects",
    targetKeyword: "M.Tech Projects & Dissertation Support",
    heroEyebrow: "Postgraduate & M.Tech Track",
    heroHeading: "M.Tech Project Development & Dissertation Guidance",
    heroDescription: "Advanced engineering projects, simulation modeling, algorithm reproduction, and thesis documentation tailored for M.Tech & M.S. scholars.",
    ...
    deliverablesList: [
      ...
      "Comprehensive M.Tech Dissertation Manuscript (LaTeX / Word)",
      "Turnitin Originality Report (< 10% Similarity)",
      "Viva Voce Presentation Slides (PPT)",
      "Step-by-Step Execution Manual & Code Walkthrough",
    ],
    processSteps: [
      { step: "01", title: "Topic Finalization", desc: "Selecting a high-impact base paper from recent IEEE Transactions." },
      ...
      { step: "04", title: "Thesis Drafting & Viva Prep", desc: "Authoring chapters according to university guidelines and preparing defense decks." },
    ],
    faqs: [
      {
      ...
      {
        question: "How do you handle guide review feedback?",
  ...
  "btech-projects": {
    slug: "btech-projects",
    targetKeyword: "B.Tech Final Year Engineering Projects",
    heroEyebrow: "Undergraduate Capstone Track",
    heroHeading: "B.Tech Engineering Projects & Working Prototypes",
    heroDescription: "Hardware prototypes, IoT systems, full-stack software, and simulation models with complete documentation and viva mentoring for B.Tech students.",
    ...
    deliverablesList: [
      ...
      "Video Demonstration & Live Execution Walkthrough",
    ],
    processSteps: [
      { step: "01", title: "Project Selection", desc: "Choosing a project scope matched to your branch syllabus and timeline." },
      { step: "02", title: "Hardware / Code Build", desc: "Developing modular code, assembling hardware, and testing sensors." },
      { step: "03", title: "System Integration", desc: "Connecting software frontends with hardware microcontrollers or cloud APIs." },
      { step: "04", title: "Report & Viva Handover", desc: "Generating standard college reports, presentation slides, and demo video." },
    ],
    faqs: [
      {
        question: "Do you provide hardware components or procurement links?",
      ...
      {
        question: "Will this project satisfy my university evaluation criteria?",
        answer: "All projects are structured according to standard university rubric requirements (problem statement, block diagrams, flowcharts, results, and viva Q&A).",
      },
    ],
  ...
  "final-year-projects": {
    ...
    heroDescription: "End-to-end technical mentoring, prototype construction, and IEEE paper reproduction for engineering students in their final semesters.",
    ...
    processSteps: [
      { step: "01", title: "Requirement Sync", desc: "Reviewing college guidelines, project duration, and team constraints." },
      { step: "02", title: "Prototype Development", desc: "Executing software modules, firmware loops, or numerical simulations." },
      { step: "03", title: "Demo & Verification", desc: "Live screen demo validating functionality against expected outputs." },
  ...
  "ieee-projects": {
    slug: "ieee-projects",
    targetKeyword: "IEEE Transactions Paper Implementation",
    heroEyebrow: "IEEE Benchmark Reproduction",
    heroHeading: "IEEE Paper Implementation & Performance Enhancement",
    heroDescription: "Exact algorithmic reproduction and novel performance enhancement of top-tier IEEE Transactions papers with comparative benchmarking.",
